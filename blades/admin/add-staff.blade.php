...
<div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="/admin" method="POST" class="my-2">
                    @csrf
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input id="user_name" type="text" class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ old('user_name') }}" placeholder="User Name" autocomplete="user_name" autofocus disabled>
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="email">Email Address<span style="color:red;">*</span></label>  
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email" autocomplete="email" autofocus>
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="state_of_origin">State Of Origin<span style="color:red;">*</span></label>
                        <input id="state_of_origin" type="text" class="form-control @error('state_of_origin') is-invalid @enderror" name="state_of_origin" placeholder="State of Origin" value="{{ old('state_of_origin') }}" autocomplete="state_of_origin" autofocus>
                    </div>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" value="" autocomplete="password" disabled autofocus>
                    </div>
