    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ asset('/staff/home') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseExam" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/staff/choose-course">Add Questions</a>
                        <a class="collapse-item" href="/staff/select-course">Add Answers</a>
                        <a class="collapse-item" href="/staff/review-questions">Review Questions</a>
                        <a class="collapse-item" href="/staff/exam-scores">Exam Scores</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseProfile" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/staff/profile">View Profile</a>
                        <a class="collapse-item" href="/staff/change-password">Change Password</a>
                    </div>
                </div>
            </li>
