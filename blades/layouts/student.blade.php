    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ asset('/student/home') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseProfile" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/student/profile">View Profile</a>
                        <a class="collapse-item" href="/student/change-password">Change Password</a>
                    </div>
                </div>
            </li>
